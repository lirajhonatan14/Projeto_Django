    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('instrucoes_medicamentos', models.CharField(blank=True, max_length=100, null=True)),
                ('autorizacao_para_cuidados_medicos', models.BooleanField(choices=[(False, 'Não'), (True, 'Sim')], default=False)),
                ('servicos_adicionais', models.ManyToManyField(blank=True, null=True, to='hotel.reservaservicoadicional')),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='hotel.servicosadicionais'),
        ),
        migrations.AddField(
            model_name='reserva',
            name='usuario',
