...
def caixa(request, num_reserva):
    ...
    if request.method == 'POST':
        ...
        if caixa_form.is_valid():
            ...
            url = reverse_lazy('caixa:relatorio', kwargs={'num_reserva': num_reserva})
            return redirect(f"{url}", target="_blank")
        else:
...
def relatorio_reservas(request, num_reserva):
    ...
    serv_adicional = caixa.num_reserva.servicos_adicionais.valor_servico
